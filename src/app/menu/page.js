...
export default function Menu() {
  return (
    <main className="h-full ">
      <div className="h-[80vh] bg-[url('/liquor_shelf.jpg')] bg-cover bg-no-repeat bg-center rounded-xl">
        <div className="w-full text-white bg-gradient-to-b from-transparent via-transparent to-black/65 p-[2rem] h-full flex flex-col justify-end rounded-xl">
          <div>
            <h1
